# Parameter-Efficient Fine-tuning FS-Adapter (freeze FS-VFM ViT-L/16) on DfD and Testing on Unseen DiFF
...
OUTPUT_DIR='./checkpoint/finetuned_models_FS-Adapter/ViT-L_VF2_600e/FT_on_FF++_DF_c23_32frames'
