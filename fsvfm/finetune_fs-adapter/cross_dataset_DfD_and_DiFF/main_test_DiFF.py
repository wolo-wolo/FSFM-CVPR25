...
cross_dataset_test_path = {
    'FF_DF': '../../../datasets/finetune_datasets/deepfakes_detection/FaceForensics/32_frames/DS_FF++_each_cls/c23/DeepFakes',
    'DiFF_T2I': '../../../datasets/finetune_datasets/diffusion_facial_forgery_detection/DiFF/test_subsets/T2I',
    'DiFF_I2I': "../../../datasets/finetune_datasets/diffusion_facial_forgery_detection/DiFF/test_subsets/I2I",
    "DiFF_FS": "../../../datasets/finetune_datasets/diffusion_facial_forgery_detection/DiFF/test_subsets/FS",
    'DiFF_FE': "../../../datasets/finetune_datasets/diffusion_facial_forgery_detection/DiFF/test_subsets/FE",
}
...
def main(args):
    ...
    if all([args.test_split, args.dataset_abs_path]):
        ...
        for ds_name, ds_path in cross_dataset_test_path.items():
            ...
            test_stats = test(data_loader_test, model, device)
    ...
    # image_aucs = [image_metric[i] for i in range(0, len(image_metric), 2)]
    #
    # # Create DataFrame
    # df = pd.DataFrame({
    #     'Dataset': datasets,
    #     'Frame-level AUC': image_aucs,
    # })
    #
    # # Save to Excel
