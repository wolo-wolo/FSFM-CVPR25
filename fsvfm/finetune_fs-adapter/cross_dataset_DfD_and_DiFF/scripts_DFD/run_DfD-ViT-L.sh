# Parameter-Efficient Fine-Tuning and Testing FS-Adapter (freeze FS-VFM ViT-L/16) for DfD
...
OUTPUT_DIR='./checkpoint/finetuned_models_FS-Adapter/ViT-L_VF2_600e/FT_on_FF++_c23_32frames'
