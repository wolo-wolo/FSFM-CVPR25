...
def main(args):
    ...
    if args.trainable_modules == 'fs-adapter':
        # freeze all parameters except the FS-adapter and a classifier/linear head
        for name, param in model.named_parameters():
            if 'adapter' not in name and 'projector' not in name and 'head' not in name:
                param.requires_grad = False

    from torchinfo import summary
    print(summary(model, input_size=(1, 3, args.input_size, args.input_size)))
