# Fine-tuning and Testing FS-VFM ViT-S/16 for Face Anti-Spoofing (LOO evaluation on MCIO protocol)
...
OUTPUT_DIR='./checkpoint/finetuned_models/ViT-S_VF2_600e/MCIO_protocol'
LEARNING_RATE=2.5e-5
WEIGHT_DECAY=1e-6

# ==============OCI2M==============
CUDA_VISIBLE_DEVICES=4 python train_vit.py \
