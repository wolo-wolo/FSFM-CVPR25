# Pre-training FS-VFM ViT-L/16 model on VGG-Face2 dataset for 600 epochs
...
CUDA_VISIBLE_DEVICES=0,1,2,3 OMP_NUM_THREADS=1 python -m torch.distributed.launch --node_rank=0 --nproc_per_node=4 \
    ...
    --output_dir ./checkpoint/pretrain_models/FS-VFM_ViT-L_VF2_600e/